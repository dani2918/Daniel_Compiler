...
* File compiled: /Users/MattDaniel/Desktop/CS_445/Daniel_Compiler/testDataA7/e01.c-
* 
* ** ** ** ** ** ** ** ** ** ** ** **
* FUNCTION input
...
* IF
 ...
 92:     ST  3,-1(1)	Save left side 
 93:    LDC  3,1(6)	Load integer constant 
 94:     LD  4,-1(1)	Load left into ac1 
 95:    TGT  3,4,3	Op >
* THEN
* EXPRESSION
*                       Begin call to  output
...
105:     ST  3,-1(1)	Save left side 
106:    LDC  3,1(6)	Load integer constant 
107:     LD  4,-1(1)	Load left into ac1 
108:    TLT  3,4,3	Op <
* THEN
* EXPRESSION
*                       Begin call to  output
...
205:     ST  3,-1(1)	Save left side 
206:    LDC  3,1(6)	Load integer constant 
207:     LD  4,-1(1)	Load left into ac1 
208:    TGT  3,4,3	Op >
* THEN
* EXPRESSION
*                       Begin call to  output
...
226:     ST  3,-1(1)	Save left side 
227:    LDC  3,1(6)	Load integer constant 
228:     LD  4,-1(1)	Load left into ac1 
229:    TLT  3,4,3	Op <
* THEN
* EXPRESSION
*                       Begin call to  output
