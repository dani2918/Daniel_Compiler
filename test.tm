...
* File compiled: /Users/MattDaniel/Desktop/CS_445/Daniel_Compiler/testDataA7/c17.c-
* 
* ** ** ** ** ** ** ** ** ** ** ** **
* FUNCTION input
...
*                       Begin call to  output
 71:     ST  1,-1(1)	Store old fp in ghost frame 
*                       Load param 1
...
*                       Jump to output
 79:    LDA  1,-1(1)	Load address of new frame 
...
* EXPRESSION
 ...
 84:     ST  3,1(1)	Save index 
 85:    LDA  3,-1(0)	Load address of base of array x
 86:     ST  3,1(1)	Save left side 
 87:    LDC  3,5(6)	Load integer constant 
 88:     LD  4,1(1)	Load left into ac1 
...
* EXPRESSION
*                       Begin call to  output
 97:     ST  1,0(1)	Store old fp in ghost frame 
*                       Load param 1
...
*                       Jump to output
105:    LDA  1,0(1)	Load address of new frame 
...
* EXPRESSION
*                       Begin call to  outnl
109:     ST  1,0(1)	Store old fp in ghost frame 
*                       Jump to outnl
110:    LDA  1,0(1)	Load address of new frame 
